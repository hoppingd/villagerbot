...
const { getOrCreateProfile, normalizeCardName } = require('../../util');
...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            console.log(err);
            try {
                await interaction.reply(`There was an error attempting **/wish**: ${err.name}.  Please report bugs [here](https://discord.gg/CC9UKF9a6r).`);
